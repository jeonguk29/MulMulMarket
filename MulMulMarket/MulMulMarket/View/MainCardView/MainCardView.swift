...
struct MainCardView: View {
    ...
    // MARK: - CARD VIEWS
    @State var cardViews: [StroyDetailView] = {
        var views = [StroyDetailView]()
        for index in 0 ..< 2 {
            views.append(StroyDetailView(honeyMoon: destinationArray[index]))
        }
        return views
    }()
    ...
    private func moveCards() {
        ...
        let newCardView = StroyDetailView(honeyMoon: honeymoon)
     ...
     */
    private func isTopCard(cardView: StroyDetailView) -> Bool {
